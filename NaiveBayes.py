...
class NaiveBayes:
    ...
    def p_word_given_label_and_pseudocount(self, word, label, alpha):
        ...
        """
        return (self.class_word_counts[label][word]+alpha) / (self.class_total_word_counts[label] + alpha*len(self.class_total_word_counts))
    ...
    def log_likelihood(self, bow, label, alpha):
        ...
        ret = 0
        for w in bow:
            ret = ret + math.log(self.p_word_given_label_and_pseudocount(w, label, alpha))
    ...
    def log_prior(self, label):
        ...
        return math.log(self.class_total_doc_counts[label] / reduce(lambda x,y: x+y, self.class_total_doc_counts.itervalues()))
